...
async function applyVerifiedBrandAssets(env, schools = []) {
  ...
  // One set-based lookup keeps the public catalog path bounded. The branding
  // table is the provenance-aware source of truth, while schools.logo_url is
  // retained as a compatibility fallback for older rows.
