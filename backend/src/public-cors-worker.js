...
const SCHOOL_CATALOG_CACHE_VERSION = "logo-render-v5-browser";
const DIRECT_LOGO_OVERRIDES = new Map([
  ...
  ["asu-mid-south", "https://www.uthsc.edu/nursing/images/asumidsouth.jpg"],
  ...
  ["shorter", "https://shortercollege.edu/wp-content/uploads/2020/11/shorter-college-logolrg.png"],
  ...
  ["ua-cossatot", "https://keystoneacademic-res.cloudinary.com/image/upload/c_pad%2Cw_3840%2Ch_1280/dpr_auto/f_auto/q_auto/v1/element/14/147022_cossatot.png"]
]);
...
async function rewriteSchoolCatalogLogos(request, response) {
  ...
  headers.set("x-localbleachers-logo-delivery", "direct-v1");
