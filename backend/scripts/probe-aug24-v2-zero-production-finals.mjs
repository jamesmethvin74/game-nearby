...
const url=`${API}/api/v1/scores?since=2026-08-24T05%3A00%3A00.000Z&until=2026-08-25T05%3A00%3A00.000Z&sport=volleyball&proof=aug24-v2-zero-state`;
...
if(matched!==0) throw new Error(`Expected zero approved finals in production; matched ${matched}`);
console.log("AUG24_V2_PRODUCTION_STATE=ZERO_PRESENT");
