...
if(/run-approved-high-school-logo-bootstrap\.sh: line \d+/.test(text)){
  console.log("HS_LOGO_FAILURE_CLASS=SHELL_RUNTIME");
  process.exit(0);
}
console.error("HS_LOGO_FAILURE_CLASS=NOT_SHELL_RUNTIME");
process.exit(1);
