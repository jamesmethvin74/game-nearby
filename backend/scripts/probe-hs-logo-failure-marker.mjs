...
if (text.includes("did not reach COMPLETE within eight bounded batches")) {
  console.log("HS_LOGO_FAILURE_CLASS=LOOP_EXHAUSTED");
  process.exit(0);
}
console.error("HS_LOGO_FAILURE_CLASS=NOT_LOOP_EXHAUSTED");
process.exit(1);
