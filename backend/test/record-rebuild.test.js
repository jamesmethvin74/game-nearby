...
test("record rebuild combines canonical and school-feed finals without double counting", () => {
  ...
  const canonicals = [
    {
      id:"ce-lakeside-a",sport:"volleyball",gender:"girls",season:"2026",
    ...
    {
      id:"ce-lakeside-b",sport:"volleyball",gender:"girls",season:"2026",
      home_school_id:"conway",away_school_id:"lakeside",home_name:"Conway High School",away_name:"Lakeside High School (Hot Springs)",
    ...
    {
      id:"ce-benton",sport:"volleyball",gender:"girls",season:"2026",
...
test("record rebuild excludes exhibition/non-record finals", () => {
  ...
  const canonicals=[{
    id:"ce-exhibition",sport:"volleyball",gender:"girls",season:"2026",home_school_id:"valley",away_school_id:"other",
