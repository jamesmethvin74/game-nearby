...
test("database record rebuild persists duplicate-safe statewide totals", async()=>{
  ...
  gameInsert.run('g-dup','a-volleyball-2026','a-statewide','native:dup','Beta High School','b','2026-08-31T23:00:00.000Z',1,'home',now,now,now,'ce-one');
  ...
  memberInsert.run('ce-one','g-dup','a-statewide','a-volleyball-2026',now);
